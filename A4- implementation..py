...
class Block:
    def __init__(self, index, timestamp, data, previous_hash):
        ...
        self.data = data  # Should be a dict containing drug info
...
# ------------------ CLI Simulation (Optional) ------------------
def cli_simulation():
    drug_chain = Blockchain()

    drug_chain.add_block({
        "stage": "Manufactured",
        "drug_id": "D12345",
    ...
    drug_chain.add_block({
        ...
        "drug_id": "D12345",
        "distributor": "HealthDistrib Pvt Ltd",
        "location": "Hyderabad"
    })
    ...
    drug_chain.add_block({
        ...
        "drug_id": "D12345",
        "customer": "Mohammed Kaif",
        "purchase_date": "2025-05-20"
    })

    print("\nBlockchain is valid:", drug_chain.is_chain_valid())
    print("\nTracing Drug D12345:")
    for record in drug_chain.trace_drug("D12345"):
        print(json.dumps(record, indent=4))


# ------------------ Run GUI or CLI ------------------
if __name__ == "__main__":
    # Uncomment below to test CLI logic before GUI
    # cli_simulation()
